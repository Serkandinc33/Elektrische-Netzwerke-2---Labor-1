...
f = 10000;  % Frequenz
Vth = -5i;  % Thevenin-Spannung
Zth = 1000+(2*pi*f*1.5*10^-3)*1i;   % Thevenin-Widerstand
...
Zlasten = Zc(Clasten, f); % Impedanzen von Kondensator-Lasten
...
for i=1:7
    ...
    leistungen_w(i) = ergebnissen_w(1)*1000;    % Leistungen für variierenden Widerstand
    leistungen_c(i) = ergebnissen_c(1)*1000;    % Leistungen für variierenden Kondensator
    Vlasten_w(i) = ergebnissen_w(2);    % Lastspannunen für variierenden Widerstand
    Vlasten_c(i) = ergebnissen_c(2);    % Lastspannunen für variierenden Kondensator
    pf_w(i) = ergebnissen_w(3);     % Leistungsfaktoren für variierenden Widerstand
    pf_c(i) = ergebnissen_c(3);     % Leistungsfaktoren für variierenden Kondensator
end
